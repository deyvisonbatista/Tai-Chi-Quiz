...
const OPTIONS = [
  ...
  "Bebo pouca água",
  "Uma boa quantidade",
  "Bebo água o dia inteiro"
];

export default function WaterIntake({ onNext, onBack }: Props) {
  return (
    <div className="min-h-screen bg-[#FDF6ED] flex flex-col items-center overflow-x-hidden font-sans relative pb-10">
      ...
      <main className="w-full max-w-[500px] flex flex-col items-center z-10 px-6">
        ...
        >
          Quanto de <span className="text-[#DE77A5]">água</span> você bebe diariamente?
        </motion.h1>
        ...
        <div className="flex flex-col gap-[14px] w-full">
          {OPTIONS.map((option, index) => (
            ...
            >
              <span className="text-black font-bold text-[1.1rem] text-center w-full pr-2">
                {option}
              </span>
