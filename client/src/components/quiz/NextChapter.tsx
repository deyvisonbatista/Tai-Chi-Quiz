...
import forestImg from "@assets/lg-bah1O-4215b7df-1803-4a89-9dfa-6c041e529965_1772052306357.png";
...
export default function NextChapter({ onNext, onBack }: Props) {
  return (
    <div className="min-h-screen bg-[#FDF6ED] flex flex-col items-center overflow-x-hidden font-sans relative pb-10">
      ...
      <div className="w-full max-w-[500px] px-6 mb-6 mt-2">
      ...
      <main className="w-full max-w-[500px] flex flex-col items-center z-10 px-6">
        ...
        >
          <img src={forestImg} alt="Mulher na floresta" className="w-full h-auto object-cover aspect-[4/3]" />
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-[1.8rem] font-bold text-black mb-5 text-center leading-tight tracking-tight"
        >
          O próximo capítulo da sua vida <span className="text-[#DE77A5]">começa hoje!</span>
        </motion.h1>
        ...
        >
          Pequenos passos levam a grandes mudanças, e estaremos com você em cada etapa do processo.
        </motion.p>
