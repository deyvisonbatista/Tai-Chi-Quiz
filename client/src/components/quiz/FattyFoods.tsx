...
const OPTIONS = [
  { text: "Eu geralmente evito", emoji: "😎" },
  { text: "3 - 5 vezes por semana", emoji: "🍗" },
  { text: "Quase todos os dias", emoji: "🤤" }
];

export default function FattyFoods({ onNext, onBack }: Props) {
  return (
    <div className="min-h-screen bg-[#FDF6ED] flex flex-col items-center overflow-x-hidden font-sans relative pb-10">
      ...
      <main className="w-full max-w-[500px] flex flex-col items-center z-10 px-6">
        ...
        >
          Com que frequência você ingere <span className="text-[#DE77A5]">alimentos gordurosos?</span>
        </motion.h1>
