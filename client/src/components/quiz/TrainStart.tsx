...
const OPTIONS = [
  { text: "Leve e tranquilo", emoji: "🌱" },
  { text: "Intermediário", emoji: "🌿" },
  { text: "Mais ativo", emoji: "⚡" },
    ...
    <div className="min-h-screen bg-[#FDF6ED] flex flex-col items-center overflow-x-hidden font-sans relative pb-10">
      ...
      <main className="w-full max-w-[500px] flex flex-col items-center z-10 px-6">
        <motion.h1 
          ...
          className="text-[1.8rem] font-bold text-black mb-4 text-center leading-tight tracking-tight px-4"
        >
          Como você prefere <span className="text-[#DE77A5]">começar</span> seu treino? 📊
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-[#333] text-[1.1rem] text-center mb-10 px-2"
        >
