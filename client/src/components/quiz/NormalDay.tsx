...
const OPTIONS = [
  "Fico a maior parte do tempo parada",
  "Me movimento pouco",
  "Sou ativa na maior parte do tempo"
];

export default function NormalDay({ onNext, onBack }: Props) {
  return (
    <div className="min-h-screen bg-[#FDF6ED] flex flex-col items-center overflow-x-hidden font-sans relative pb-10">
      ...
      <main className="w-full max-w-[500px] flex flex-col items-center z-10 px-6">
        ...
        >
          Como você descreveria um dia <span className="text-[#DE77A5]">normal</span> seu?
        </motion.h1>
        ...
        <div className="flex flex-col gap-[14px] w-full">
          {OPTIONS.map((option, index) => (
            ...
            >
              <span className="text-black font-bold text-[1.1rem] text-left pr-4 leading-tight">
                {option}
              </span>
