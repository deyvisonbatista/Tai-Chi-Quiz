...
const OPTIONS = [
  "Engordo com facilidade, mas tenho dificuldade para emagrecer",
  "Meu peso sobe e desce com facilidade",
  "Tenho dificuldade em ganhar peso ou músculos"
];

export default function WeightChange({ onNext, onBack }: Props) {
  return (
    <div className="min-h-screen bg-[#FDF6ED] flex flex-col items-center overflow-x-hidden font-sans relative pb-10">
      ...
      <div className="w-full max-w-[500px] px-6 mb-16 mt-4">
      ...
      <main className="w-full max-w-[500px] flex flex-col items-center z-10 px-6">
        ...
        >
          Como seu <span className="text-[#DE77A5]">peso</span> costuma mudar?
        </motion.h1>
        ...
        <div className="flex flex-col gap-[14px] w-full">
          {OPTIONS.map((option, index) => (
            <motion.button
              ...
              className="w-full bg-[#EBE0D6] hover:bg-[#E2D4C8] border border-[#E0D3C9] transition-all duration-300 rounded-[14px] py-[22px] px-6 flex items-center justify-between shadow-[0_2px_8px_rgba(0,0,0,0.03)] active:scale-[0.98] group"
            >
              <span className="text-black font-bold text-[1.1rem] text-center w-full leading-tight pr-2">
                {option}
              </span>
