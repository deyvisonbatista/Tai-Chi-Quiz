...
import neckImg from "@assets/lg-OnXSc-design-sem-nome-2026-01-22t154139559_1772045846955.png";
...
export default function NeckStiffness({ onNext, onBack }: Props) {
  return (
    <div className="min-h-screen bg-[#FDF6ED] flex flex-col items-center overflow-x-hidden font-sans relative pb-10">
      ...
      <main className="w-full max-w-[500px] flex flex-col items-center z-10 px-6">
        ...
        >
          Você sente <span className="text-[#DE77A5]">dificuldade ou rigidez</span> ao virar o pescoço de um lado para o outro?
        </motion.h1>
        ...
        >
          <img src={neckImg} alt="Mulher virando o pescoço" className="w-full h-auto object-cover aspect-[4/3] sm:aspect-[16/9]" />
        </motion.div>
